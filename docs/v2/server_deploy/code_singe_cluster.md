...
kafka:
  ws2mschat:
    ...
    topic: "ws2ms_chat" im_msg写入，im_msg_transfer消费后新消息入库redis和kafka "msg_to_mongo" 、 "ms2ps_chat"
  ws2mschatoffline:
    addr: [  127.0.0.1:9092, 127.0.0.2:9092, 127.0.0.3:9092 ] #kafka配置，默认即可
    topic: "ws2ms_chat_offline" 不再使用
  msgtomongo:
    addr: [  127.0.0.1:9092, 127.0.0.2:9092, 127.0.0.3:9092 ] #kafka配置，默认即可
    topic: "msg_to_mongo"  im_msg_transfer消费历史消息入库mongo
  ms2pschat:
    addr: [  127.0.0.1:9092, 127.0.0.2:9092, 127.0.0.3:9092 ] #kafka配置，默认即可
...
msg_transfer_name="im_msg_transfer"
msg_transfer_binary_root="../bin/"
msg_transfer_source_root="../cmd/im_msg_transfer/"
